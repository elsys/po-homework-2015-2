...
task2.c:22:3: warning: format â%ldâ expects argument of type âlong intâ, but argument 2 has type âintâ [-Wformat=]
   printf("%ld", find(hayStack, Needle) - hayStack);
   ^
task2.c:14:8: warning: unused variable âresultâ [-Wunused-variable]
  char *result = NULL;
        ^
