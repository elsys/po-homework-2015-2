...
task2.c:22:10: warning: format '%ld' expects argument of type 'long int', but argument 2 has type 'int' [-Wformat=]
   printf("%ld", find(hayStack, Needle) - hayStack);
          ^
task2.c:14:8: warning: unused variable 'result' [-Wunused-variable]
  char *result = NULL;
        ^
